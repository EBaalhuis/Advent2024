...
//    [<TestMethod>]
//    member this.Day13Part1 () =
//        let expected = 36870
//        let actual = Advent2024.Day13Part1.result
//        Assert.AreEqual(expected, actual);

//    [<TestMethod>]
//    member this.Day13Part2 () =
//        let expected = 78101482023732L
//        let actual = Advent2024.Day13Part2.result
//        Assert.AreEqual(expected, actual);

//    [<TestMethod>]
//    member this.Day14Part1 () =
//        let expected = 232253028
//        let actual = Advent2024.Day14Part1.result
//        Assert.AreEqual(expected, actual);

//    [<TestMethod>]
//    member this.Day14Part2 () =
//        let expected = 8179
//        let actual = Advent2024.Day14Part2.result
//        Assert.AreEqual(expected, actual);

//    [<TestMethod>]
//    member this.Day15Part1 () =
//        let expected = 1463715
//        let actual = Advent2024.Day15Part1.result
//        Assert.AreEqual(expected, actual);

//    [<TestMethod>]
//    member this.Day15Part2 () =
//        let expected = 1481392
//        let actual = Advent2024.Day15Part2.result
//        Assert.AreEqual(expected, actual);

//    [<TestMethod>]
//    member this.Day16Part1 () =
//        let expected = 88468L
//        let actual = Advent2024.Day16Part1.result
//        Assert.AreEqual(expected, actual);

//    [<TestMethod>]
//    member this.Day16Part2 () =
//        let expected = 616
//        let actual = Advent2024.Day16Part2.result
//        Assert.AreEqual(expected, actual);

    [<TestMethod>]
    member this.Day17Part1 () =
        let expected = "1,5,7,4,1,6,0,3,0"
        let actual = Advent2024.Day17Part1.result
        Assert.AreEqual(expected, actual);

    [<TestMethod>]
    member this.Day17Part2 () =
        let expected = 108107574778365I
        let actual = Advent2024.Day17Part2.result
        Assert.AreEqual(expected, actual);

    [<TestMethod>]
    member this.Day18Part1 () =
        let expected = 384L
        let actual = Advent2024.Day18Part1.result
        Assert.AreEqual(expected, actual);

    [<TestMethod>]
    member this.Day18Part2 () =
        let expected = "36,10"
